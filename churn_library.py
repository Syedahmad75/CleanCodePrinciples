# library doc string
'''
Description:This is the churn_notebook.ipynb file containing the solution to identify 
credit card customers that are most likely to churn. This module containes and optimizes
the given in churn_notebook.ipynb. This is the main file of the project 'Predict customer
Churn with Clean Code'.

Author: Syed Muhammad Ahmad
